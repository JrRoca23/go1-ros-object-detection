...
unitree_legged_msgs::MotorState state2rosMsg(const UNITREE_LEGGED_SDK::MotorState &state)
{
...
unitree_legged_msgs::IMU state2rosMsg(const UNITREE_LEGGED_SDK::IMU &state)
{
...
unitree_legged_msgs::BmsState state2rosMsg(const UNITREE_LEGGED_SDK::BmsState &state)
{
...
unitree_legged_msgs::LowState state2rosMsg(const UNITREE_LEGGED_SDK::LowState &state)
{
...
unitree_legged_msgs::Cartesian state2rosMsg(const UNITREE_LEGGED_SDK::Cartesian &state)
{
...
unitree_legged_msgs::HighState state2rosMsg(const UNITREE_LEGGED_SDK::HighState &state)
{
